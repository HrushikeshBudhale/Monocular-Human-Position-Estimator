...
\hypertarget{index_autotoc_md5}{}\doxysubsection{$<$a href=\char`\"{}https\+://docs.\+google.\+com/document/d/1\+Ov0n0\+Fi\+Roefbu\+Tpb\+J\+C\+Gna\+Qu\+J2t1\+R9\+M\+H\+B2j\+\_\+\+Gy\+Z\+Q0sz\+Y/edit?usp=sharing\char`\"{}$>$\+Sprint planning notes$<$/a$>$}\label{index_autotoc_md5}
\hypertarget{index_autotoc_md6}{}\doxysubsection{Deliverables}\label{index_autotoc_md6}
...
Doxygen generated documentation can be found \href{https://github.com/HrushikeshBudhale/Monocular-Human-Position-Estimator/blob/main/docs/html/index.html}{\texttt{ here}}. ~\newline
...
Checked for memory leaks uing valgrind. No memory leaks found. output can be found \href{https://github.com/HrushikeshBudhale/Monocular-Human-Position-Estimator/blob/development/results/valgrind_output.txt}{\texttt{ here}}
